...
// This is the FINAL STABLE version without the broken fireworks.
...
function createCar() {
    ...
    // THE FIX: We use MeshStandardMaterial, which supports 'emissive'.
    const headlightMat = new THREE.MeshStandardMaterial({ color: 0xffffee, emissive: new THREE.Color(0xffffee) });
    const brakelightMat = new THREE.MeshStandardMaterial({ color: 0xff0000, emissive: new THREE.Color(0xff0000) });
...
function createWorldObjects() {
    ...
    // The reliable glowing yellow block
...
function createChristmasStar() {
    ...
    // THE FIX: Use MeshStandardMaterial, which supports 'emissive'
    const starMat = new THREE.MeshStandardMaterial({ color: 0xfde047, emissive: new THREE.Color(0xfde047) });
